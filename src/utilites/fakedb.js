...
const deleteFromDb = (name) => {
    ...
    // remove korte chaile thekte hobe ter vitore kisu ase ki na jodi na thake tahole nicher condition kaj korbe
     if(!exists){ 
     ...
     // jodi theke thahole shopping cart k parse korte hoeb
         ...
         delete shopping_cart[name]; //shopping_cart er vitore name thakle seta k delet kore dibo and baki name gulo storage set kore dibo
...
//49-3 (advanced) Load cart from local storage, find product
 ...
 export {addDb, deleteFromDb as removeFromDb , clearCart ,getStoreCart} ;